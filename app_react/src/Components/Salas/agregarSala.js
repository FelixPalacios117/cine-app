...
const AgregarSala = (props) => {
    ...
    const onSubmit=(data)=>{
        ...
        axiosCliente.post('/new-movie',formData).
        then(res=>{
            console.log(res); 
            if(res.status===200){
                Swal.fire(
            ...
            <section className="max-w-4xl p-6 mx-auto bg-gray-700 rounded-md shadow-md dark:bg-gray-800 mt-20">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" htmlFor="capacity">Capacida</label>
                            <input id="capacity"
                                name="capacity"
                                type="text"
                                className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" htmlFor="row">Fila</label>
                            <input id="row"
                                name="row"
                                type="text"
                                className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" htmlFor="column">Columna</label>
                            <input
                                name="column"
                                id="column"
                                type="text"
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" htmlFor="disable">Disable</label>
                            <input
                                name="disable"
                                id="disable"
                                type="text"
