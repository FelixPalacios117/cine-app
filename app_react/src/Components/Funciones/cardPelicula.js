					...
					<div className="flex-auto sm:ml-5 justify-evenly">
						<div className="flex items-center justify-between sm:mt-2">
							<div className="flex items-center">
								<div className="flex flex-col">
									<div className="w-full flex-none text-lg text-gray-600 font-bold leading-none">Aji</div>
						...
						<div className="flex flex-row items-center"> 
							...
							<div className="flex pt-2  text-sm text-gray-600">
								...
								<button  className="flex-no-shrink bg-green-600 hover:bg-green-500 px-5 ml-4 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-green-300 hover:border-green-500 text-white rounded-full transition ease-in duration-300">FOLLOW</button>
							</div>
						</div>
					</div>
				</div>
